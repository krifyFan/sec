...
/** 获取设备类型、状态的统计信息 */
export function getEquipmentTypeStateStatisticeByStation(stationId: number) {
    return request({
        url: `stations/${stationId}/equipment_type_state_statistic`,
        method: 'get'
    })
}
 ...
 */
export function getEquipmentTree(stationId: number){
    return request({
        url: `/stations/${stationId}/equipment_tree`,
        method: 'get',
    })
}
