    ...
    <div style="overflow-y: auto; height: 85vh;">
        ...
        <Modal v-model="flag_add" title="新增" @on-ok="addOk" @on-cancel="addCancel">
            <Form :model="addItem" :label-width="120">
                ...
                <FormItem label="父节点ID:">
                    <el-select v-model="addItem.fatherId" @change="addSelectChange" class="form-content-width">
                ...
                <FormItem label="所属类型:">
                    <Input v-model="addItem.type" class="form-content-width"/>
                </FormItem>
                <FormItem label="所在表ID:">
                    <Input v-model="addItem.usedId" class="form-content-width"/>
                </FormItem>
                <FormItem label="连接状态:">
        ...
        <Modal v-model="flag_edit" title="编辑" @on-ok="editOk" @on-cancel="editCancel">
            <Form :model="editItem" :label-width="120">
                ...
                <FormItem label="父节点ID:">
                    <el-select v-model="editItem.fatherId" @change="editSelectChange" class="form-content-width">
                        <el-option v-for="item in netNodes" :value="item.id" :key="item.id" :label="item.name">
                        </el-option>
                    </el-select>
                </FormItem>
                ...
                <FormItem label="所属类型:">
                    <Input v-model="editItem.type" class="form-content-width"/>
                </FormItem>
                <FormItem label="所在表ID:">
                    <Input v-model="editItem.usedId" class="form-content-width"/>
                </FormItem>
                <FormItem label="连接状态:">
