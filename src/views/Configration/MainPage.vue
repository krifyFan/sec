                ...
                <Sider hide-trigger>
                    <Menu theme="dark" width="auto" accordion :open-names="['1']" @on-select="itemSelect">
                        ...
                        <Submenu name="3">
                            ...
                            <MenuItem name="videogroup">
                                <Icon type="ios-navigate" />
                                视频分组
                            </MenuItem>
                            <MenuItem name="videoLinkages">
                                <Icon type="ios-navigate" />
                                视频联动
                            </MenuItem>
                            ...
                            <MenuItem name="laserMethane">
                                <Icon type="ios-navigate" />
                                激光甲烷
                            </MenuItem>
                            <MenuItem name="regularinspection">
                                <Icon type="ios-navigate" />
                                定时巡检    
                            </MenuItem>
                        </Submenu>
                        ...
                        <Submenu name="5">
                            ...
                            <MenuItem name="fireAlarmConfig">
                            <Icon type="ios-navigate" />
                            火灾报警
                            </MenuItem>
                            <MenuItem name="securitystaff">
                            <Icon type="ios-navigate" />
                            保安页面设置
                            </MenuItem>
                            <MenuItem name="realInfoConfig">
                            <Icon type="ios-navigate" />
                            实时信息
                            </MenuItem>
                        </Submenu>
