<template>
    <div>
        ...
        <div class="top">
            ...
            <div v-for="(moduleItem, index) in moduleConfig" :key="index" :class="moduleItem.value">
                ...
                <el-select size="mini" v-model="moduleItem.value" placeholder="请选择" class="select" @change="
                    ...
                    <el-option v-for="moduleNameItem in moduleName" :key="`${moduleNameItem.value}${index}`" :label="moduleNameItem.label" :value="moduleNameItem.value">
                    </el-option>
                </el-select>
                ...
                <div class="video" v-if="moduleItem.groupId !== -1">
                    ...
                    <el-select size="mini" v-model="moduleItem.groupId" placeholder="请选择" class="select">
                        <el-option v-for="group in videoGroupList" :key="`${group.id}`" :label="group.name" :value="group.id">
                        </el-option>
                    </el-select>
                </div>
                <el-button type="danger" icon="el-icon-delete" circle size="mini" style="margin-left: 5px" @click="remove(index)"></el-button>
            </div>
        ...
        <div class="moduleConfig">
            <div class="modules" v-for="(moduleItem, index) in moduleConfig" :key="`${moduleItem.value}${index}${moduleItem.id}`" :style="moduleStyle(index)">
