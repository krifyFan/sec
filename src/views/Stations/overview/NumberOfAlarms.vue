    ...
    <div class="number_of_alarms">
        ...
        <Modal v-model="modelData.show" width="800" footer-hide>
            ...
            <div style="text-align:right">
                ...
                <Page :total="modelData.page.total" :page-size="modelData.page.pageSize" :current="modelData.page.current" show-total show-sizer @on-change="currentChange" @on-page-size-change="pageSizeChange" />
            </div>
...
<script lang="ts">
    ...
    export default class NumberOfAlarms extends Vue {
        ...
        searchData() {
            ...
            getAlarmsByCondition(data).then((res: any) => {
                let {
                    code,
                    data
                } = res.data;
