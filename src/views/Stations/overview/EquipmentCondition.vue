    ...
    <div class="equipment_condition">
        ...
        <div class="condition_box">
            <div class="statistics_data">
                ...
                <p v-for="item in equipmentStatistic" :key="item.key" class="data_item">
                    <span class="data_circel data_online_circel" v-if="item.key == '在线'"></span>
                    <span class="data_circel data_notonline_circel" v-else-if="item.key == '离线'"></span>
        ...
        <Modal v-model="modelData.show" width="800" footer-hide>
        ...
        initChart() {
            ...
            let initOption: EChartOption = {
                title: {
                    ...
                    textStyle: {
                        color: "#91FDFF",
                        fontSize: this.getSizeByWidth("8%"),
                        fontWeight: "bold"
                    },
                    subtext: (Number(pieData[0].value) / this.totalCount * 100).toFixed(0) + "%",
                    subtextStyle: {
                        color: "#91FDFF",
                        fontSize: this.getSizeByWidth("8%"),
                        fontWeight: "bold"
        ...
        getSizeByWidth(val: number | string): number {
            ...
            if (typeof val === "string") {
                if (val.indexOf("%") > 0) {
                    ...
                    let height = document.getElementById("conditionId").offsetWidth;
