...
export class AudioWithIE {
    ...
    playSound(fileName: string) {
        ...
        request({
            ...
            _this._audio.setAttribute("src", "data:audio/wav;base64," + btoa(new Uint8Array(res.data).reduce((data, byte) => data + String.fromCharCode(byte), "")))
        })
    }
}